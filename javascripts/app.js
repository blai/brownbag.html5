...
(this.require.define({
  "lib/css3d": function(exports, require, module) {
    (function() {
  var CSS3D;
...
(this.require.define({
  ...
  module.exports = ImpressView = (function(_super) {
    ...
    ImpressView.prototype.el = "#impress";

    ImpressView.prototype.canvas = null;

    ImpressView.prototype.$canvas = null;

    ImpressView.prototype.stepsData = {};

    ImpressView.prototype.activeStep = null;

    ImpressView.prototype.currentState = null;

    ImpressView.prototype.steps = null;

    ImpressView.prototype.config = null;

    ImpressView.prototype.windowScale = null;
    ...
    ImpressView.prototype.initStep = function(el, idx) {
      var data, step;
      data = el.dataset;
      step = {
        translate: {
...
(this.require.define({
  "views/templates/impress": function(exports, require, module) {
    module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  var foundHelper, self=this;


  return "<div id=\"impress\">\n	<div id=\"canvas\"></div>\n</div>";});
  }
}));
(this.require.define({
